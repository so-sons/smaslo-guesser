...
window.GAME_CONFIG = {
  ...
  siteUrl: "https://so-sons.github.io/smaslo-guesser/",
  ...
  // --- 画像（空文字にすると画像なしで動く） ---
  imageBase: "https://www.pachislot-summit.com/wp/wp-content/uploads/",
  imageExt: "",

  // --- 機種データの読み方 ---
  fields: { name: "n", kana: "k", alias: "a", image: "i", main: null },
  // 候補リストの右側に出す補足（任意）
